...
Return ONLY valid JSON matching this exact schema. Use 0 or [] when nothing changed:
{
  ...
  "status_effects_gained": string[],  // effects gained — use canonical names with optional duration in parens. Format: "Name" or "Name (duration)". Apply EVERY buff/debuff/condition that lands on a PC, including minor ones like Guidance. Conditions: Unconscious, Dead, Poisoned, Blinded, Frightened, Paralyzed, Stunned, Prone, Charmed, Exhausted, Restrained, Petrified, Deafened, Grappled, Invisible, Incapacitated, Burning. Buffs: Blessed, Hasted, Raging, Inspired, Shielded, Concentrating, Flying, Regenerating, Wild Shaped, Bardic Inspiration, Death Ward, Sanctuary, Guidance, Resistance, Aided, Heroism, Shield of Faith, Protected, Barkskin, Longstrider, Enlarged. Debuffs: Cursed, Hexed, Marked, Silenced, Weakened, Hunter's Mark, Baned, Slowed, Reduced. Diseases: Diseased, Infected, Fevered, Sewer Plague. Enchantments: Attuned, Empowered, Enchanted, Mage Armor, Mirror Image. Use the effect form not the spell name: Bless→Blessed, Bane→Baned, Haste→Hasted, Aid→Aided, Enlarge→Enlarged.
